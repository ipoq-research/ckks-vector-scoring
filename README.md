...
Start with the [research article](docs/what-it-takes-to-benchmark-encrypted-vector-scoring-honestly.md), [release audit](docs/RELEASE_AUDIT.md), and [security scope](SECURITY.md). Source repository: [ipoq-research/ckks-vector-scoring](https://github.com/ipoq-research/ckks-vector-scoring). See [repository setup notes](docs/REPOSITORY_SETUP.md) for the relationship to the audited archive. A future `ipoq.com` article can link here.
